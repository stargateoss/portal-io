 ...
 */
package dev.stargateoss.portal.io.file.filefilter;
 ...
 * See {@link ApacheFilenameUtils#wildcardMatchOnSystem} for more information.
 * <p>
 * For example:
 * <pre>
 * File dir = new File(".");
...
public class WildcardFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public boolean accept(final File dir, final String name) {
        for (final String wildcard : wildcards) {
            if (ApacheFilenameUtils.wildcardMatch(name, wildcard, caseSensitivity)) {
                return true;
            }
        }
        return false;
