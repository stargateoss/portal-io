...
import dev.stargateoss.portal.io.file.ApacheFilenameUtils;
import dev.stargateoss.portal.io.file.IOCase;

/**
 * Compare the file name <b>extensions</b> for order
 * (see {@link ApacheFilenameUtils#getExtension(String)}).
 * <p>
...
public class ExtensionFileComparator extends AbstractFileComparator implements Serializable {
    ...
    public int compare(final File file1, final File file2) {
        final String suffix1 = ApacheFilenameUtils.getExtension(file1.getName());
        final String suffix2 = ApacheFilenameUtils.getExtension(file2.getName());
